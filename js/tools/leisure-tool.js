/* 休闲娱乐：二级菜单外壳，页内左侧竖直菜单为三级菜单（当前：漂流瓶） */
window.DaibaoTools = window.DaibaoTools || {};

window.DaibaoTools.createLeisureTool = function (container) {
  ...
  container.innerHTML = `
    <div class="it-layout">
      <aside class="it-menu">
        <div class="it-menu-title">休闲娱乐</div>
      ...
      <section class="it-content" id="leContent"></section>
    </div>`;

  var content = container.querySelector('#leContent');
