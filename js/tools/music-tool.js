/* 歌词下载（音乐音频二级菜单）：页内左侧竖直菜单外壳，子功能可扩展注册 */
window.DaibaoTools = window.DaibaoTools || {};

window.DaibaoTools.createMusicTool = function (container) {
  // 子功能注册表：后续新增音乐相关工具在这里加一条即可
  var subTools = [
    { key: 'qqmusic-lyric', name: 'QQ Music 歌词', render: DaibaoTools.createQqMusicLyric },
    { key: 'kugou-lyric', name: '酷狗歌词', render: DaibaoTools.createKugouLyric },
  ];

  container.innerHTML = `
    <div class="it-layout">
      <aside class="it-menu">
        <div class="it-menu-title">歌词下载</div>
      ...
      <section class="it-content" id="mtContent"></section>
    </div>`;

  var content = container.querySelector('#mtContent');
